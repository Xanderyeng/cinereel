...
export default function AnimatedDialog({ celebrities, gtmEvent }: AnimatedDialogProps) {
  return (
    <AnimatePresence>
        ...
        <DialogContent className=" max-w-[90vw] rounded-lg md:rounded-md sm:max-w-[425px]"aria-label="Other fellow movie stars" aria-describedby="other-partners">
            <motion.div
             ...
             <DialogDescription>
              ...
              <ScrollArea className="h-[400px] pr-4">
                <motion.div
                  ...
                  aria-label="Other fellow movie stars" aria-describedby="other-partners"
                >
